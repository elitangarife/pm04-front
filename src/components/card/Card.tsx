...
const Card: React.FC <IProduct> = ({id, name, price,image}) => {
  ...
  return (
    <div className="flex justify-center text-center w-full p-4 sm:w-72 md:w-80 lg:w-96">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col gap-2 hover:shadow-md hover:scale-105 transition-shadow duration-200 sm:w-72 md:w-80 lg:w-96 h-120 items-center">      
