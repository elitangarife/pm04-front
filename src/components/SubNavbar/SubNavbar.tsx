...
const SubNavbar = () => {
  return (
    <div className="bg-gray-200 w-full mx-auto font-semibold flex items-center justify-between px-4 py-2">
      ...
      {/* Menú de enlaces, centrado en pantallas grandes */}
      <div className="hidden sm:flex sm:justify-center w-full space-x-6 text-xs sm:text-base md:text-lg">
